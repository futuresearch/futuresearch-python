...
class MultiAgentOperation:
    ...
    Attributes:
        ...
        effort_level (None | PublicEffortLevel | Unset): Controls the parallel direction agents: low (3 agents) and
            medium (4 agents) run fast; high (2 frontier agents) does deeper but slower research. Default:
            PublicEffortLevel.MEDIUM.
