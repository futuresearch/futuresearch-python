...
[Add the everyrow connector if you haven't already.](/claude-ai) Then upload a CSV with 200 text samples from the [DBpedia-14 dataset](https://huggingface.co/datasets/fancyzhx/dbpedia_14) and ask Claude:
...
Built with [everyrow](https://github.com/futuresearch/everyrow-sdk). Related guides: [Classify DataFrame Rows](/classify-dataframe-rows-llm) (label data at scale), [Deduplicate Training Data](/deduplicate-training-data-ml) (clean ML datasets before training).
