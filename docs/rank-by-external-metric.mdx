...
[Add the everyrow connector if you haven't already.](/claude-ai) Then upload a CSV of the top 300 PyPI packages (with `package` and `monthly_downloads` columns) and ask Claude:
