...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload [b2b_companies.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/b2b_companies.csv) and ask Claude:
