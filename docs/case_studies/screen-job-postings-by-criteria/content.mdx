...
Go to [everyrow.io/app](https://everyrow.io/app), upload [job_postings.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/job_postings.csv), and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload [job_postings.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/job_postings.csv) and ask Claude:
