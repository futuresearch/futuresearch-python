...
Go to [everyrow.io/app](https://everyrow.io/app), upload crm_contacts.csv and crm_funds.csv, and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload crm_contacts.csv and crm_funds.csv and ask Claude:
