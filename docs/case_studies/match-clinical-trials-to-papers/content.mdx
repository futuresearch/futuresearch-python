...
Go to [everyrow.io/app](https://everyrow.io/app), upload papers_700.csv and trials_200.csv, and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload papers_700.csv and trials_200.csv and ask Claude:
