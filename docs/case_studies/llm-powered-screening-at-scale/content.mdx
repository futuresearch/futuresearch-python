...
Go to [everyrow.io/app](https://everyrow.io/app), upload the FDA product recalls CSV, and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload the FDA product recalls CSV and ask Claude:
