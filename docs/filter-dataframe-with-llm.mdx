...
Go to [everyrow.io/app](https://everyrow.io/app), upload [hn_jobs_screen.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/hn_jobs_screen.csv), and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload [hn_jobs_screen.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/hn_jobs_screen.csv) and ask Claude:
