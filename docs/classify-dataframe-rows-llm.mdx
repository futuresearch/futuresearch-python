...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload [hn_jobs_classify.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/hn_jobs_classify.csv) and ask Claude:
