...
Go to [everyrow.io/app](https://everyrow.io/app), upload [fda_products.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/fda_products.csv), and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload [fda_products.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/fda_products.csv) and ask Claude:
...
Built with [everyrow](https://github.com/futuresearch/everyrow-sdk). See the [dedupe documentation](reference/DEDUPE) for more options. Related guides: [Resolve Duplicate Entities](/docs/resolve-entities-python) (500-row CRM walkthrough), [Deduplicate Training Data](/docs/deduplicate-training-data-ml) (semantic dedup for ML datasets).
