...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload a CSV of 3,000 sentences from the [PAWS](https://huggingface.co/datasets/google-research-datasets/paws) paraphrase dataset and ask Claude:
