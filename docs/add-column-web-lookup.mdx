...
Go to [everyrow.io/app](https://everyrow.io/app), upload [saas_products.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/saas_products.csv), and enter:
...
[Add the everyrow connector if you haven't already.](/docs/claude-ai) Then upload [saas_products.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/saas_products.csv) and ask Claude:
