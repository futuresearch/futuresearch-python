...
[Add the everyrow connector if you haven't already.](/claude-ai) Then upload [saas_products.csv](https://media.githubusercontent.com/media/futuresearch/everyrow-sdk/refs/heads/main/docs/data/saas_products.csv) and ask Claude:
